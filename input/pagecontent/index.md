...
Refer to the **[mapping from the logical model of HI to the logical model based on IPS](mappings.html)** in order to get an idea how the IPS can be used in this context.