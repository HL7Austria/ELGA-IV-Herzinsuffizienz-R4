...
* $sct#171044003 "Immunization education"
* $sct#171044003 ^designation[0].language = #de-AT
* $sct#171044003 ^designation[0].value = "?Impfberatung?"
* $sct#733833000 "Education about self-monitoring"
* $sct#733833000 ^designation[0].language = #de-AT
* $sct#733833000 ^designation[0].value = "?Edukation über Selbst-Monitoring?"